jQuery(document).ready(function(){
	...
	* 	Checkbox
	*/
	jQuery('.checkbox-pseudo a').on("click", function() { 
	...
	* 	Selectbox Custom
	*/
	jQuery('.option_custom_select a').on("click", function() { 
	...
	*/
	...
	jQuery("select#page_template option, .editor-page-attributes__template select").each(function () { 
		var val = jQuery(this).val();
