...
$kona_options = array(
	...
	array( "name" => esc_html__("Footer", 'kona'),
		   ...
		   "desc" => ""
		  	...
		  	array( "label" => esc_html__("Footer Settings", 'kona'),
				...
				array( "label" => esc_html__("Footer Background Color", 'kona'),
					   "desc" => "",
					   "id" => "_sr_footerbg",
					   "type" => "color"
					  ),
	
				array( 	"label" => esc_html__("Footer Text Color", 'kona'),
					   "desc" => "",
						"id" => "_sr_footertext",
						"type" => "selectbox",
					   	"option" => array( 
	...
	array( "name" => esc_html__("Shop Settings", 'kona'),
		   ...
		   "desc" => ""
			...
			array( "label" => esc_html__("Ajax Shop Features", 'kona'),
				   "id" => "_sr_shop-ajax",
				   "type" => "groupstart"
				  ),
	
					array( 	"label" => esc_html__("Add to Cart", 'kona'),
							"desc" => esc_html__("Do you want to enable ajax for adding products to cart?", 'kona'),
							"id" => "_sr_shopajaxadd",
					   		"type" => "checkbox-hiding",
							"option" => array(
								array(	"name" => esc_html__("Yes", 'kona'), 
					...
					array( 	"label" => esc_html__("Remove Product from cart", 'kona'),
							"desc" => esc_html__("Enable ajax for removing products from the cart?", 'kona'),
							"id" => "_sr_shopajaxremove",
					   		"type" => "checkbox",
							"option" => array(
								array(	"name" => esc_html__("Yes", 'kona'), 
										"value"=> "1"),
					...
					array( 	"label" => esc_html__("Change cart amount", 'kona'),
							"desc" => esc_html__("Enable ajax for changing the amount of the cart products?", 'kona'),
							"id" => "_sr_shopajaxchange",
					   		"type" => "checkbox",
							"option" => array(
								array(	"name" => esc_html__("Yes", 'kona'), 
										"value"=> "1"),
