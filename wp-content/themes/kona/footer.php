...
if (get_option('_sr_footerbottom') || get_option('_sr_footercopyright')) { $hideFooter = false; }

$footerClass = "";
if (get_option('_sr_footertext')) { $footerClass = get_option('_sr_footertext'); }
...
?>
    ...
    <!-- FOOTER -->  
    <footer id="footer">
       	<div class="footer-inner wrapper <?php echo esc_attr($footerClass); ?>">
	...
	<?php if (class_exists('Woocommerce') && get_option('_sr_shopgridquickview')) { ?>
    <!-- QUICK VIEW --> 
	<div id="quick-view">
